...
def sum_nimp_with_charges(profs):
    ...
    return (total_density, imp_el_density, imp_density)
...
signals = ('NE','NI','NMINI','BDENS')
#ion_signals = ['NI','NMINI','BDENS']
ion_signals = ['NI','BDENS','NMINI']
...
total_imp_el_density, imps_el_densities, _ = sum_nimp_with_charges(profs)
...
fig = plt.figure()                                                                                  
fig.suptitle(f'Densities at {profs.t[tind]+40:.3f}s', fontsize=13)                                                      
...
if profs.xzimps is not None:
    fig = plt.figure()                                                                                  
    fig.suptitle(f'Imp. avg. effective charge at {profs.t[tind]+40:.3f}s', fontsize=13)                                                      
    ax = fig.add_subplot(111)  
    for imp in profs.impurities: 
        ax.plot(
            profs.x[ps.gi(profs.transp_time,time)],
...
if profs.zeffp is not None: 
    fig = plt.figure()                                                                                  
    fig.suptitle(f' 2D Effective charge at {profs.t[tind]+40:.3f}s', fontsize=13)                                                      
    ax = fig.add_subplot(111)  
    ax.plot(
        profs.x[ps.gi(profs.transp_time,time)],
